...
train_generator = datagen.flow_from_directory(
        DATASET_DIR,
        target_size = (100, 100), # ridimensiamo le immagini a dimensione comune
...
model.add(Conv2D(filters=64, kernel_size=4, padding="same", activation="relu", input_shape=(100, 100, 3)))
